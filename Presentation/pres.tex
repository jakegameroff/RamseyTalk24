...
\begin{itemize}
	...
	\item A {\color{cyan}{{\emph{super elegant}}}} application of Ramsey's theorem to analysis
\end{itemize}
\end{frame}
...
\begin{frame}
    \frametitle{$K_5$ with No Monochrome $K_3 \Leftrightarrow R(3) \geq 6$}
    \begin{figure}
        \centering
...
\end{enumerate}
Let \( c \in  \{ {\color{red}{\mbox{red}}}, {\color{blue}{\mbox{blue}}} \}  \) be such that \( c = c_{k}  \) for infinitely many \( k \). Then \( A = \{ x_{k} : c_{k} = c \}  \) has edges only with color \( c \).
\end{proof}
\end{frame}
...
\begin{frame}
    \begin{figure}
        ...
        \begin{minipage}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{/Users/jakeg/Desktop/RamseyTalk24/Presentation/images/1.png}
        \end{minipage}
        \hfill
        \begin{minipage}{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{/Users/jakeg/Desktop/RamseyTalk24/Presentation/images/2.png}
        \end{minipage}
    \end{figure}
\end{frame}
